...
mod tests {
    use super::*;
    use crate::{
        DefinitionState, EndpointInputDefinition, EndpointInputLocation, FieldDefinition,
        FieldOptions, FieldRelation, FunctionGraph, FunctionNode, FunctionNodeEditor,
        MenuRowActions, ModelAuditDefinition, ModelDefinition, PageDefinition,
        PageEndpointDefinition, PortDefinition, RelationKind, RestMethod, TableDefinition,
    };
    ...
    fn permission_usage_counts_every_supported_reference_owner() {
        ...
        let mut root_actions = MenuRowActions::default();
        root_actions.edit = crate::MenuActionAccess::Permission { permission_id };
