...
use az_str::transformation::{normalize_url_path, split_url_path_segments};
pub use inventory;
...
macro_rules! register_admin_domain {
    (
        ...
        $crate::navigation::inventory::submit! {
            $crate::navigation::AdminDomainRegistration {
                id: $id,
                label: $label,
                order: $order,
...
macro_rules! __register_admin_navigation {
    (
        ...
        $crate::navigation::inventory::submit! {
            $crate::navigation::AdminNavigationRegistration {
                kind: $kind,
                id: $id,
                domain_id: $domain_id,
                parent_id: $parent_id,
...
macro_rules! register_admin_branch {
    (
        ...
        $crate::__register_admin_navigation! {
            kind: $crate::navigation::AdminNavigationKind::Branch,
            id: $id,
            domain: $domain_id,
            parent: $parent_id,
            label: $label,
...
macro_rules! register_admin_page {
    (
        ...
        $crate::__register_admin_navigation! {
            kind: $crate::navigation::AdminNavigationKind::Page,
            id: $id,
            domain: $domain_id,
            parent: $parent_id,
            label: $label,
