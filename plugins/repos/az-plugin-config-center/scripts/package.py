#!/usr/bin/env python3
"""Build an AIO `.azplugin` package for the config center plugin."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=DEFAULT_CATALOG / "config-center.azplugin",
    ...
    shutil.copy2(
        ROOT / "assets" / "biz-dotfiles-summary.json",
        stage / "assets" / "biz-dotfiles-summary.json",
    )
